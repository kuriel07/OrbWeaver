...
char 		{ return P_BYTE; }
short		{ return P_HWORD; }
int 		{ return P_WORD; }
long 		{ return P_DWORD; }
float 		{ return P_FLOAT; }
double 		{ return P_DOUBLE; }
string		{ return P_STRING; }
void 		{ return P_VOID; }
ptr		{ return P_PTR; }
iptr		{ return P_AUTO; }		//intelligent pointer
...
stdcall		{ return P_STDCALL; }
fastcall	{ return P_FASTCALL; }
...
foreach		{ return P_FOREACH; }
in			{ return P_IN; }
try			{ return P_TRY; }
catch		{ return P_CATCH; }
