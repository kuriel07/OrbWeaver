...
namespace StackLib {
	...
	public :
		...
		void RegisterResource(System::String^ constant, array<System::Byte>^ bytes);
		void CleanUp();
	...
	public:
		...
		int Decode(VM_DEF_ARG, int offset) ;
		int Decode(VM_DEF_ARG);
		void InvokeException(VM_DEF_ARG, int code);
